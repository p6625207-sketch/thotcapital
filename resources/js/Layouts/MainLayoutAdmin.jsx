...
export default function Layout({ title, children }) {
  return (
    <div className="min-h-screen flex flex-col bg-[#020617] text-slate-200 relative selection:bg-amber-500/30">
      ...
      <AdminHeader className="sticky top-0 z-50 bg-[#020617]/80 backdrop-blur-md border-b border-slate-800" />

      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {children}
      </main>

      <AdminFooter className="bg-[#020617] border-t border-slate-800 py-10" />
    </div>
  );
}